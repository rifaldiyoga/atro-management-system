...
class ItemSeeder extends Seeder
{
  public function run(): void
  {
    ...
    Item::create([
      ...
      'unit'          => 'METER',
      'price'         => 180000.00,
      'lastpurcprice' => (true ? (180000.00) : 0),
    ...
    Item::create([
      ...
      'unit'          => 'EA',
      'price'         => 215000.00,
      'lastpurcprice' => (true ? (215000.00) : 0),
      'description'   => '' ?: $faker->sentence(10),
      'active'        => true,
      'photo_url'     => '' ?: null,
    ]);
    ...
    Item::create([
      ...
      'unit'          => 'BOX',
      'price'         => 750000.00,
      'lastpurcprice' => (true ? (750000.00) : 0),
...
' ?: $faker->sentence(10),
    ...
    Item::create([
      ...
      'unit'          => 'SET',
      'price'         => 135000.00,
      'lastpurcprice' => (true ? (135000.00) : 0),
      'description'   => '' ?: $faker->sentence(10),
      'active'        => true,
      'photo_url'     => '' ?: null,
    ]);
    ...
    Item::create([
      ...
      'unit'          => 'EA',
      'price'         => 123123123.00,
      'lastpurcprice' => (true ? (123123123.00) : 0),
      'description'   => '' ?: $faker->sentence(10),
      'active'        => true,
      'photo_url'     => '' ?: null,
    ]);
    ...
    Item::create([
      ...
      'unit'          => 'EA',
      'price'         => 100000.00,
      'lastpurcprice' => (true ? (100000.00) : 0),
      'description'   => '' ?: $faker->sentence(10),
      'active'        => true,
      'photo_url'     => '' ?: null,
    ]);
    ...
    Item::create([
      ...
      'unit'          => 'SHEET',
      'price'         => 260000.00,
      'lastpurcprice' => (true ? (260000.00) : 0),
      'description'   => '' ?: $faker->sentence(10),
      'active'        => true,
      'photo_url'     => '' ?: null,
    ]);
    ...
    Item::create([
      ...
      'unit'          => 'EA',
      'price'         => 350000.00,
      'lastpurcprice' => (true ? (350000.00) : 0),
      'description'   => '' ?: $faker->sentence(10),
      'active'        => true,
      'photo_url'     => '' ?: null,
    ]);
    ...
    Item::create([
      ...
      'unit'          => 'EA',
      'price'         => 857500.00,
      'lastpurcprice' => (true ? (857500.00) : 0),
      'description'   => '' ?: $faker->sentence(10),
      'active'        => true,
      'photo_url'     => '' ?: null,
    ]);
    ...
    Item::create([
      ...
      'unit'          => 'EA',
      'price'         => 2000000.00,
      'lastpurcprice' => (true ? (2000000.00) : 0),
    ...
    Item::create([
      ...
      'unit'          => 'SHEET',
      'price'         => 328000.00,
      'lastpurcprice' => (true ? (328000.00) : 0),
      'description'   => '' ?: $faker->sentence(10),
      'active'        => true,
      'photo_url'     => '' ?: null,
    ]);
    ...
    Item::create([
      ...
      'unit'          => 'EA',
      'price'         => 450000.00,
      'lastpurcprice' => (true ? (450000.00) : 0),
...
' ?: $faker->sentence(10),
    ...
    Item::create([
      ...
      'unit'          => 'EA',
      'price'         => 385000.00,
      'lastpurcprice' => (true ? (385000.00) : 0),
...
' ?: $faker->sentence(10),
    ...
    Item::create([
      ...
      'unit'          => 'EA',
      'price'         => 435000.00,
      'lastpurcprice' => (true ? (435000.00) : 0),
...
' ?: $faker->sentence(10),
    ...
    Item::create([
      ...
      'unit'          => 'METER',
      'price'         => 123000.00,
      'lastpurcprice' => (true ? (123000.00) : 0),
      'description'   => '' ?: $faker->sentence(10),
      'active'        => true,
      'photo_url'     => '' ?: null,
    ]);
    ...
    Item::create([
      ...
      'unit'          => 'EA',
      'price'         => 240000.00,
      'lastpurcprice' => (true ? (240000.00) : 0),
      'description'   => '' ?: $faker->sentence(10),
      'active'        => true,
      'photo_url'     => '' ?: null,
    ]);
    ...
    Item::create([
      ...
      'unit'          => 'EA',
      'price'         => 36500000.00,
      'lastpurcprice' => (true ? (36500000.00) : 0),
      'description'   => '' ?: $faker->sentence(10),
      'active'        => true,
      'photo_url'     => '' ?: null,
    ]);
    ...
    Item::create([
      ...
      'unit'          => 'EA',
      'price'         => 3780000.00,
      'lastpurcprice' => (true ? (3780000.00) : 0),
...
Material : ASTM 128 GR B2' ?: $faker->sentence(10),
    ...
    Item::create([
      ...
      'unit'          => 'EA',
      'price'         => 49111000.00,
      'lastpurcprice' => (true ? (49111000.00) : 0),
      'description'   => '' ?: $faker->sentence(10),
      'active'        => true,
      'photo_url'     => '' ?: null,
    ]);
    ...
    Item::create([
      ...
      'unit'          => 'EA',
      'price'         => 115000.00,
      'lastpurcprice' => (true ? (115000.00) : 0),
      'description'   => '' ?: $faker->sentence(10),
      'active'        => true,
      'photo_url'     => '' ?: null,
    ]);
    ...
    Item::create([
      ...
      'unit'          => 'EA',
      'price'         => 3700000.00,
      'lastpurcprice' => (true ? (3700000.00) : 0),
      'description'   => '' ?: $faker->sentence(10),
      'active'        => true,
      'photo_url'     => '' ?: null,
    ]);
...
BUAT SENDIRI' ?: $faker->sentence(10),
    ...
    Item::create([
      ...
      'unit'          => 'EA',
      'price'         => 3000000.00,
      'lastpurcprice' => (true ? (3000000.00) : 0),
      'description'   => '' ?: $faker->sentence(10),
      'active'        => true,
      'photo_url'     => '' ?: null,
    ]);
    ...
    Item::create([
      ...
      'unit'          => 'EA',
      'price'         => 2500000.00,
      'lastpurcprice' => (true ? (2500000.00) : 0),
      'description'   => '' ?: $faker->sentence(10),
      'active'        => true,
      'photo_url'     => '' ?: null,
    ]);
    ...
    Item::create([
      ...
      'unit'          => 'EA',
      'price'         => 7500000.00,
      'lastpurcprice' => (true ? (7500000.00) : 0),
      'description'   => '' ?: $faker->sentence(10),
      'active'        => true,
      'photo_url'     => '' ?: null,
    ]);
    ...
    Item::create([
      ...
      'unit'          => 'ROLL',
      'price'         => 9000000.00,
      'lastpurcprice' => (true ? (9000000.00) : 0),
...
300.000/M 1ROLL=30M' ?: $faker->sentence(10),
    ...
    Item::create([
      ...
      'unit'          => 'EA',
      'price'         => 1000000.00,
      'lastpurcprice' => (true ? (1000000.00) : 0),
      'description'   => '' ?: $faker->sentence(10),
      'active'        => true,
      'photo_url'     => '' ?: null,
    ]);
    ...
    Item::create([
      ...
      'unit'          => 'ROLL',
      'price'         => 11500000.00,
      'lastpurcprice' => (true ? (11500000.00) : 0),
    ...
    Item::create([
      ...
      'unit'          => 'EA',
      'price'         => 760000.00,
      'lastpurcprice' => (true ? (760000.00) : 0),
      'description'   => '' ?: $faker->sentence(10),
      'active'        => true,
      'photo_url'     => '' ?: null,
    ]);
