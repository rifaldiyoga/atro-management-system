...
class SalesOrder extends Model
{
  ...
  protected static function booted()
  {
    static::saving(function ($model) {
      if (empty($model->trxno) || $model->trxno === 'AUTO') {
        $model->trxno = TransactionHelper::generateTrxNo(static::class, 'SO', $model->trxdate);
      }
    });
  }
  ...
  {
    return $this->hasMany(SalesOrderDetail::class, 'so_id', 'id');
  }
  ...
  {
    return $this->hasMany(Attachment::class, 'refid', 'id')->where('reftype', 'SO');
  }
}
